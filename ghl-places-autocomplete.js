...
var GHLPlaces = {
    ...
    initCheckboxes: function() {
        var termsContainers = document.querySelectorAll('.terms-and-conditions');
        for (var i = 0; i < termsContainers.length; i++) {
            termsContainers[i].addEventListener('click', GHLPlaces.handleCheckboxClick);
        }
    },
